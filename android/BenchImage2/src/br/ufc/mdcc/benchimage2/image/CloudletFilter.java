...
/**
 * This interface support method offloading with cloudlet preference pre-configured
 * 
 * @author Philipp B. Costa
 */
public interface CloudletFilter extends Filter {
	@Remotable
	...
	@Remotable(value = Offload.STATIC, status = true)
